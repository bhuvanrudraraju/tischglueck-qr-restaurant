...
const menu = [
  ...
  { id: 'burger', category: 'Hauptgerichte', name: 'Tischglück Burger', description: 'Rind, Cheddar, karamellisierte Zwiebeln, Pommes', price: 19.5, emoji: '🍔', tag: null },
